...
class RoleCrudController extends BaseCrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('created_at')->label('Дата создания')->attributes(['disabled' => 'disabled']);
        CRUD::field('updated_at')->label('Дата редактирование')->attributes(['disabled' => 'disabled']);
    }
